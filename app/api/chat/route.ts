...
- For time/hours or limit/ceiling questions, prefer the consolidated R1/R2 reference tables over scattered mentions elsewhere; if the sub-type isn't specified, answer all relevant sub-types rather than picking one or saying no info.
- Never cite internal clause numbers ("ข้อ 6.3", "Q12") — translate into plain language.
